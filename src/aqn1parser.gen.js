...
function peg$parse(input, options) {
  ...
  function peg$f1(ops, mod) {
    return { type: "Query", selectors: ops, modifier: mod ? mod.value : null };
  }
  function peg$f2(n) {
    return { type: "index", value: n };
  }
  function peg$f3(t) {
    return { type: "tag", value: t };
  }
  function peg$f4() {
    return { type: "decode" };
  }
  function peg$f5(m) {
    return { type: "modifier", value: m };
  }
  function peg$f6(hex) {
